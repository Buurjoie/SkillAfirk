      ...
      <div className="container mx-auto px-4 py-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
              ...
              <div className="p-4">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <p>
                    {videos[currentVideo]?.snippet.channelTitle}
                  </p>
                  </div>
                  ...
                  >
                    <i
                      className={`fas ${watchedVideos?.includes(videos[currentVideo]?.id) ? "fa-check-square text-green-600" : "fa-square"}`}
                    ></i>
            ...
            {/* Forum Preview */}
            <VideoWithComments videoId={videos[currentVideo]?.snippet?.resourceId?.videoId} />
          </div>
              ...
              <div className="p-2 max-h-[500px] overflow-y-auto">
                <ul className="divide-y divide-gray-100">
                  {videos?.map((video, index) => (
                    <li
                      key={video.id}
                      className={`p-2 hover:bg-gray-50 cursor-pointer transition-colors ${currentVideo === index ? "bg-orange-50" : ""}`}
