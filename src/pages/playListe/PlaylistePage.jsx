...
import { searchPlaylists } from '../../libs/youtubData';
...
export default function PlaylistePage() {
  ...
  const fetcheData = () =>{
    const query = idFormation.toLowerCase().replace(/-/g, " ");
...
const formations = data.domaines.flatMap((domaine) =>
  domaine.formations.filter((formation) =>
    ...
    formation.title.toLowerCase().replace(/\s+/g, "-") === idFormation
  )
);
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Link to={`/lecture/${idFormation}/${playlist.id.playlistId}`}
