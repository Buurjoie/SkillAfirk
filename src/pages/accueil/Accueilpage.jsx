        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" id='com'>
            {dataDomaines.map((domain, index) => (
              <Link
              key={index}
              to={`/domaines/formation/${domain.title.toLowerCase().replace(/\s+/g, "-")}`}
 ...
 <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-12">
            ...
            <Link to="/domaines/formation" className="px-4 py-2 border border-[#FF6B35] text-[#FF6B35] rounded-lg hover:bg-[#FF6B35] hover:text-white transition-colors !rounded-button cursor-pointer whitespace-nowrap">
              Voir tout
            </Link>
          </div>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                     <Link  to={`/formation/${course.title.toLowerCase().replace(/\s+/g, "-")}`}
    ...
    <section class="py-16 bg-gradient-to-r from-[#FF6B35] to-[#4CAF50] text-white">
        <div class="container mx-auto px-4 text-center">
            <h2 class="text-3xl font-bold mb-6">Prêt à commencer votre voyage d'apprentissage?</h2>
